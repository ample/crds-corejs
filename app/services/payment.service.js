(function() {
  ...
  angular.module('crossroads.core').factory('PaymentService', PaymentService);

  PaymentService.$inject = ['$http','$q', 'stripe', '$cookies', 'MESSAGES'];

  function PaymentService($http, $q, stripe, $cookies, MESSAGES) {
    var paymentService = {
